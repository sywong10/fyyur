...
def venues():
  ...
  # city_and_state = Venue.query.distinct(Venue.city, Venue.state).all()
  # venues = Venue.query.filter_by(Venue.city==places.city, Venue.state=places.state)
  #
  ...
  # for cs in city_and_state:
  #   venues=Venue.query.filter_by(Venue.city == city_and_state.city, Venue.state = city_and_state.state).all()
  #
  #   for venue in venues:
  #     if venue.city
  #
...
def show_artist(artist_id):
  ...
  # return render_template('pages/sally.html', artist=data)
#
#  Update
#  ----------------------------------------------------------------
...
def shows():
  ...
  get_show = Show.query.join(Artist).join(Venue).all()
  ...
  return render_template('pages/sally.html', shows=get_show)
