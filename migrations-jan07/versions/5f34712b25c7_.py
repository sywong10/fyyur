...
Revision ID: 5f34712b25c7
Revises: 60caf1b99637
Create Date: 2022-01-05 21:25:34.472128
...
revision = '5f34712b25c7'
down_revision = '60caf1b99637'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('image_link', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
